...
from Ultimate_Machine.forms.user import PasswordForm, EmailForm, UsernameForm
from Ultimate_Machine.extensions import mail
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        from Ultimate_Machine.settings import Config
